...
#   /compensazione — письмо GARANZIA (компенсация); файл: Lettera di compensazione_<safe>.pdf
# -----------------------------------------------------------------------------
...
def main():
    ...
    print("📋 Поддерживаемые документы: /contratto, /garanzia, /carta, /approvazione, /компенсация (итальянские алиасы)")
